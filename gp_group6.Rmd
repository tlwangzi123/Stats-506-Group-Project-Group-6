...
The complete code of sas process:
https://github.com/tlwangzi123/Stats-506-Group-Project-Group-6/raw/master/gp.sas
...
we can see that at first the intercept is 1.6369, which is not 0 here. Because we use the variable
...
The coefficient of 'b_Sexl' is -0.1408, which is significant because p-value is less than 0.0001 less than 0.05. 
...
The coefficient of 'b_SexM' is -0.02083, which is not significant because the p-value is 0.2074 greater 
...
The coefficient of 'b_Length' is 1.4944, which is significant because p-value is less than 0.0001 less than 0.05. 
Thus, when the length of abalone increases one unit, the log count of its rings will increases 1.4944 unit. 
